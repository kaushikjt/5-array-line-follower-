...
void loop() {
  ...
  if((s1 == 0) && (s2 == 0) && (s3 == 1) && (s4 == 0) && (s5 == 0))
  {
    ...
    analogWrite(e1, 225); //you can adjust the speed of the motors from 0-255
    analogWrite(e2, 225); //you can adjust the speed of the motors from 0-255
  ...
  if((s1 == 0) && (s2 == 1) && (s3 == 0) && (s4 == 0) && (s5 == 0))
  {
    ...
    analogWrite(e1, 190); //you can adjust the speed of the motors from 0-255
    analogWrite(e2, 190); //you can adjust the speed of the motors from 0-255
    digitalWrite(m1, HIGH);
    digitalWrite(m2, LOW);
    digitalWrite(m3, LOW);
    digitalWrite(m4, LOW);
